...
// Login User (POST METHOD) (/api/v1/auth/login)
// Public route
...
// Log Out User / Clear Cookie (GET METHOD) (/api/v1/auth/logout)
// Private route
...
// Update user details (PUT METHOD) (/api/v1/auth/updatedetails)
// Private route
...
// Update user password (PUT METHOD) (/api/v1/auth/updatepassword)
// Private route
...
// Reset password (PUT METHOD) (/api/v1/auth/resetpassword/:resettoken)
// public route
